...
public class Constants {
    ...
    public static final String BASE_URL = "https://app.vaservices.eu/BcmPay-p2bMobileServer/";
    ...
    public static final int [] TRUSTED_CERTIFICATES = new int[]{
            0x5b40264, 0xedce3c9d, 0x81d67923, 0xba0d5e6f, 0xf8ef1633, 0xbf82af25, 0x539bafa7, 0x99010f47,      // CN=app.vaservices.eu, OU=Sicurezza, O=SIA S.p.A, L=Milano, ST=Milano, C=IT
    ...
    public static final String SERVER_ENV = "PRODUCTION";
