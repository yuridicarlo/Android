...
public class BottomDialogBankLocation {
    ...
    public BottomDialogBankLocation(AppCompatActivity activity, DisplayData displayData) {
    ...
    public void showDialog() {
        ...
        View bottomSheetView = LayoutInflater.from(context).inflate(R.layout.bank_location_bottomsheet_layout, null);
