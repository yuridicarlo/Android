...
public class BottomDialogHmsPetrolLocation {
    ...
    public BottomDialogHmsPetrolLocation(AppCompatActivity activity, DisplayData displayData) {
    ...
    public void showDialog() {
        ...
        View bottomSheetView = LayoutInflater.from(context).inflate(R.layout.hms_petrol_location_bottomsheet_layout, null);
        dialog.setContentView(bottomSheetView);

        ImageView imageMapBackground = dialog.findViewById(R.id.image_petrol_map_background);
        ...
        hmsMapFragment = (SupportMapFragment) this.supportFragmentManager.findFragmentById(R.id.fragment_petrol_static_map);
