...
public class AppConstants {
    ...
    public static final String BASE_URL = "https://app-te.vaservices.eu/BcmPay-p2bMobileServer/";
    ...
    public static final boolean PINNING_ENABLED = !BuildConfig.DEBUG;
    ...
    public static final String SERVER_ENV = "UAT";
