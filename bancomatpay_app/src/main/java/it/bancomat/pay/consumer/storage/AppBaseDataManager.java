...
import it.bancomatpay.sdk.core.SecurityHelperDummy;
import it.bancomatpay.sdk.core.SecurityStorageHelperInterface;
import it.bancomatpay.sdk.manager.utilities.CustomLogger;

public abstract class AppBaseDataManager extends SQLiteOpenHelper {

    protected static final String TAG = AppBaseDataManager.class.getSimpleName();

    protected byte[] seed;
    protected SecurityStorageHelperInterface securityHelperInterface;

    protected static final String DATABASE_NAME = "data_app";
    ...
    public AppBaseDataManager(byte[] seed, SecurityStorageHelperInterface securityHelperInterface, int version) {
        super(BancomatApplication.getAppContext(), DATABASE_NAME, null, version);
        this.seed = seed;
        this.securityHelperInterface = securityHelperInterface;
    }

    public AppBaseDataManager(int version) {
        ...
        try {
            if (cursor.moveToFirst()) {
                do {
                    ...
                    String value = cursor.getString(cursor.getColumnIndexOrThrow(COLUMN_DATA));
        ...
        try {
            if (cursor.moveToFirst()) {
                do {
                    ...
                    String chiperValue = cursor.getString(cursor.getColumnIndexOrThrow(COLUMN_DATA));
