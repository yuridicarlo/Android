...
public class StoreLocatorSearchPhysicalTask extends CancelableTask<ShopList> {
    ...
    public StoreLocatorSearchPhysicalTask(OnCompleteResultListener<ShopList> mListener, String shopName, BcmLocation location, int page) {
        super(mListener);
    ...
    protected void start() {
        ...
        dtoGetShopListRequest.setShopType(ShopType.FISICO);
        if(location != null) {
